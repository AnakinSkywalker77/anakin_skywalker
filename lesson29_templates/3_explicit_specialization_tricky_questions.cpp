...
templates:
	explicit specialization: or full specialization
		...
		note that explicit specialization is not added to function overload resolution
			explicit specialization, wherever it is located, it specializes the template before itself
