...
template <typename T>
class Myclass<T*>{		// this template partial specialization will be used for all pointer types
public:
	Myclass()
	{
...
template <typename T>
class Myclass<T&> {		// this partial template will be used for all reference types
public:
	Myclass()
	{
		cout << "partial specialization Myclass<T &> \n";
...
template <typename T>
class Myclass<T[]> {		// this partial template will be used for all array types
public:
	Myclass()
	{
		cout << "partial specialization Myclass<T []> \n";
...
template <typename T>
class Myclass<T[10]> {		// this partial template will be used for all array types with size 10
public:
	Myclass()
	{
