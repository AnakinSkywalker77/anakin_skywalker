...
templates:
	partial specialization:
		a question: do not use modern cpp (cpp11), write a meta function that calculates "a power b"  during compile time
		meta function:
			it is a class template which can evaluate value or argument type during compile time
				normal functions does the calculations and stuff during runtime
			...
			note: meta function is not a function template, it is a class template, it is called "meta function" as
				there is a calculation done, and calculation is done during compile time
*/
