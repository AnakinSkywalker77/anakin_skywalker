...
int main()
{
	...
	// if there is no explicit specialization: fatal error C1202: recursive type or function dependency context too complex

	cout << val << '\n';
}
// as it is constexpr, functions are done during compile time, and your program's exe size is not effected by this
